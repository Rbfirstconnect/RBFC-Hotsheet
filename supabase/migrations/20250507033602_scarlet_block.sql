/*
  ...
  1. Changes
    - Update available_plans format to match:
      [{"price":25,"type":"port_in"},{"price":50,"type":"port_in"},{"price":60,"type":"port_in"},
       {"price":25,"type":"pay_later"},{"price":50,"type":"pay_later"},{"price":60,"type":"pay_later"}]
