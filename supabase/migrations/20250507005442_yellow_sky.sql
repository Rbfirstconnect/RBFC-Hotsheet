/*
  ...
  1. Changes
    - Update pricing for all phone brands
    - Recreate phone plans with correct plan types
    - Set boost protect pricing based on phone tier
*/
...
-- Insert pay later plans
INSERT INTO phone_plans (phone_id, plan_price, plan_type)
SELECT id, 25, 'pay_later'
FROM phones;

INSERT INTO phone_plans (phone_id, plan_price, plan_type)
SELECT id, 50, 'pay_later'
FROM phones;

INSERT INTO phone_plans (phone_id, plan_price, plan_type)
SELECT id, 60, 'pay_later'
FROM phones;